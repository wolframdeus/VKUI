...
export default withFrame(class ConfigProvider extends React.Component<ConfigProviderProps & FrameProps> {
  ...
  setScheme = (scheme: AppearanceSchemeType): void => {
    this.props.document.body.setAttribute('scheme', scheme);
  };
