...
Мы работаем над качеством библиотеки и подвозим тесты. `yarn test` запускает все возможные тесты, yarn `test:unit` — только быстрые юниты. Подробности — в нашем [гайде по тестированию](./TESTING.md).
